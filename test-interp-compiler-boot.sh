...
# scheme --script make-compiler.scm "./interp.out interp-compiler.scm
scheme --script run-test.scm "./interp.out interp-compiler.scm ~a"
scheme --script run-test.scm "./interp.out interp-compiler.scm ~a" "./interp-compiler.out" "./interp-compiler.out ~a"
